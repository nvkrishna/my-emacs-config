...
(defvar color-themes
  '((color-theme-aalto-dark "Aalto Dark" "Jari Aalto <jari.aalto@poboxes.com>")
    ...
    (color-theme-beige-diff "Beige Diff" "Alex Schroeder <alex@gnu.org>")
    ...
    (color-theme-salmon-diff "Salmon Diff" "Alex Schroeder <alex@gnu.org>")
    (color-theme-salmon-font-lock "Salmon Font-Lock" "Alex Schroeder <alex@gnu.org>")
    ...
    (color-theme-standard-ediff "Standard Ediff" "Emacs Team, added by Alex Schroeder <alex@gnu.org>")
